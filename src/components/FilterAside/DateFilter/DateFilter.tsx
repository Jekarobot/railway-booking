...
const DateFilter = () => {
  ...
  return (
    <div className={styles.filterAside__groupDate}>
      <div className={styles.inputGroup}>
        <h2 className={styles.filterAside__header}>Дата поездки</h2>
        <input
          type="text"
      ...
      <div className={styles.inputGroup}>
        <h2 className={styles.filterAside__header}>Дата возвращения</h2>
        <input
          type="text"
          className={styles.inputField}
          placeholder="ДД/ММ/ГГ"

...
import WiFiIcon from '../../shared/assets/svg/SVGR/WiFi.tsx'
import ExpressIcon from '../../shared/assets/svg/SVGR/Express.tsx'
import FoodIcon from '../../shared/assets/svg/SVGR/Food.tsx'

interface TrainCardProps {
  ticket: RouteItem | null
  onSelect?: () => void
  buttonType: 'selectSeats' | 'returnToPick' // два типа кнопок
  onButtonClick?: () => void // функция для кнопки, если это не "Выбрать места"
}

const TrainCard = ({ ticket, onSelect, buttonType, onButtonClick }: TrainCardProps) => {
      ...
      <div className={styles.places}>
        ...
        <div className={styles.places__bottom}>
          ...
          {buttonType === 'selectSeats' ? (
            ...
            <button className={styles.returnButton} onClick={handleButtonClick}>
              Изменить
            </button>
          )}
        </div>
